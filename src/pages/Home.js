    ...
    <main class="min-vh-100">
        ...
        <div class="container-lg my-5">
            ...
            <div class="col-lg-6">
                ...
                <img class="img-fluid mx-auto d-block rounded" src={require("../assets/images/origami_dragon_2.jpg")} alt="Pic of origami dragon" />
        ...
        <div class="container-lg my-5">
            ...
            <div class="col-lg-6">
                <figure class="p-3" onMouseOver={showCaption} onMouseOut={hideCaption}>
                <img class="img-fluid mx-auto d-block rounded" src={require("../assets/images/paper_crane_2.jpg")} alt="Pic of traditional crane" />
        ...
        <div class="container-lg my-5">
            ...
            <div class="col-lg-6">
                <figure class="p-3" onMouseOver={showCaption} onMouseOut={hideCaption}>
                <img class="img-fluid mx-auto d-block rounded" src={require("../assets/images/folding_origami_2.jpg")} alt="Pic of someone paper folding" />
