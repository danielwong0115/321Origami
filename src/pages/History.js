        ...
        <div class="container-lg my-5">
            ...
            <div class= "col-lg-4">
                ...
                <figure class="p-1" onMouseOver={showCaption} onMouseOut={hideCaption}>
                    <img class="img-fluid mx-auto d-block rounded" src={`${process.env.PUBLIC_URL}/images/person11.jpg`} alt="Pic of Akira Yoshizawa" />
            ...
            <div class= "col-lg-4">
                ...
                <figure class="p-1" onMouseOver={showCaption} onMouseOut={hideCaption}>
                    <img class="img-fluid mx-auto d-block rounded" src={`${process.env.PUBLIC_URL}/images/person2_1.jpg`} alt="Pic of Satoshi Kamiya" />
            ...
            <div class= "col-lg-4">
                ...
                <h2>Robert Lang</h2>
                <figure class="p-1" onMouseOver={showCaption} onMouseOut={hideCaption}>
                    <img class="img-fluid mx-auto d-block rounded" src={`${process.env.PUBLIC_URL}/images/person32.jpg`} alt="Pic of Robert Lang" />
